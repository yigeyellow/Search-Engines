...
<title><?php if (!empty($q)) echo "搜索：" . strip_tags($q) . " - "; ?>Search 搜索 - Powered by xunsearch</title>
  ...
  <div class="row">
    ...
    <div class="span12">
      ...
      <dl class="result-list">
        ...
        <dt>
          <a href="javascript:void(alert('pid: <?php echo $doc->id; ?>'));"><h4><?php echo $doc->rank(); ?>. <?php echo $search->highlight(htmlspecialchars($doc->title)); ?> <small>[<?php echo $doc->percent(); ?>%]</small></h4></a>          
        </dt>
        <dd>
...
<footer>
  <div class="container">
    <p>(C)opyright 2011 - Search search - 页面处理总时间：<?php printf('%.4f', $total_cost); ?>秒<br>
      Powered by <a href="http://www.xunsearch.com/" target="_blank" title="开源免费的中文全文检索">xunsearch/1.4.15</a></p>
  </div>
</footer>
